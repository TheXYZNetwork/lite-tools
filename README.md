...
- [Precision](https://steamcommunity.com/sharedfiles/filedetails/?id=104482086) | Push/Pull, Rotate & Snap.
...
Pretty much all the systems use some snippet or other from the original system. From memory, some of the [Precision](https://steamcommunity.com/sharedfiles/filedetails/?id=104482086) based tools use snippets, for example, push/pull uses some precision code for getting the direction to move. The [Shadow Remover](https://steamcommunity.com/sharedfiles/filedetails/?id=1274272415) tool also uses the same method in the already existing addon.
